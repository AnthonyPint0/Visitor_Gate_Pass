...
router.get("/visitor-sessions", async (req, res) => {
  try {
...
router.post("/checkin-visitor", async (req, res) => {
  try {
...
router.get("/get-checked-in-ids", async (req, res) => {
  try {
...
router.get("/retrieve-visitor-details", async (req, res) => {
  const { id } = req.query;
  try {
